...
public class IzvrsiZamenuGUI extends JFrame {
	...
	public IzvrsiZamenuGUI(MenjacnicaGUI glavniProzor, Valuta valuta) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				IzvrsiZamenuGUI.class.getResource("/icons/Screenshot.png")));
		...
		GUIKontroler.prikaziValutu(textFieldProdajniKurs, textFieldKupovniKurs,
				textFieldValuta, valuta);
	}
		...
		if (btnIzvrsiZamenu == null) {
			...
			btnIzvrsiZamenu.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.izvrsiZamenu(valuta, rdbtnProdaja,
							textFieldIznos, textFieldKonacniIznos);
				}
			});
